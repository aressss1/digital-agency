    ...
    return (
        <div className=" bg-dark_blue" >
            <div className=" lg:px-20 md:px-14 px-4 lg:py-16 py-10 " >
                <div className="bg-orange p-24 flex flex-col justify-between gap-5" >

                <div className="flex justify-between md:flex-row flex-col md:gap-0 gap-1" >
                    <div className="lg:w-[56rem] md:w-[40rem] text-stone-50 lg:text-7xl md:text-5xl text-3xl  font-medium lg:leading-[5rem] md:leading-[3.5rem] leading-[2.5rem] ">
